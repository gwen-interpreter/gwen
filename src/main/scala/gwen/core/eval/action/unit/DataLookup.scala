...
class DataLookup[T <: EvalContext](dataName: String, name: String, filepath: Option[String], filepathRef: Option[String], jsPredicate: String) extends UnitStepAction[T] {
