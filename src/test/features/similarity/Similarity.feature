Feature: Similarity
  ...
  Scenario: Similarities ignoring case
    Given Healed is "Healed"
     Then @IgnoreCase Healed should be 80% similar to "sealed"
      And @IgnoreCase Healed should be 80% similar to "Sealed"
      And @IgnoreCase Healed should not be 80.01% similar to "sealed"
      And @IgnoreCase Healed should not be 80.01% similar to "Sealed"
      And @IgnoreCase Healed should not be 79.99% similar to "sealed"
      And @IgnoreCase Healed should not be 79.99% similar to "Sealed"
      And @IgnoreCase Healed should be 54.55% similar to "healthy"
      And @IgnoreCase Healed should be 54.55% similar to "Healthy"
      And @IgnoreCase Healed should be less than 55% similar to "healthy"
      And @IgnoreCase Healed should be less than 55% similar to "Healthy"
      And @IgnoreCase Healed should be at most 55% similar to "healthy"
      And @IgnoreCase Healed should be at most 55% similar to "Healthy"
      And @IgnoreCase Healed should be more than 54% similar to "healthy"
      And @IgnoreCase Healed should be more than 54% similar to "Healthy"
      And @IgnoreCase Healed should be at least 54% similar to "healthy"
      And @IgnoreCase Healed should be at least 54% similar to "Healthy"
      And @IgnoreCase Healed should not be less than 54% similar to "healthy"
      And @IgnoreCase Healed should not be less than 54% similar to "Healthy"
      And @IgnoreCase Healed should not be at most 54% similar to "healthy"
      And @IgnoreCase Healed should not be at most 54% similar to "Healthy"
      And @IgnoreCase Healed should not be more than 55% similar to "healthy"
      And @IgnoreCase Healed should not be more than 55% similar to "Healthy"
      And @IgnoreCase Healed should not be at least 55% similar to "healthy"
      And @IgnoreCase Healed should not be at least 55% similar to "Healthy"
      And @IgnoreCase Healed should not be 55% similar to "healthy"
      And @IgnoreCase Healed should not be 55% similar to "Healthy"
      And @IgnoreCase Healed should be 44.44% similar to "heard"
      And @IgnoreCase Healed should be 44.44% similar to "Heard"
      And @IgnoreCase Healed should be less than 45% similar to "heard"
      And @IgnoreCase Healed should be less than 45% similar to "Heard"
      And @IgnoreCase Healed should be at most 45% similar to "heard"
      And @IgnoreCase Healed should be at most 45% similar to "Heard"
      And @IgnoreCase Healed should be more than 44% similar to "heard"
      And @IgnoreCase Healed should be more than 44% similar to "Heard"
      And @IgnoreCase Healed should be at least 44% similar to "heard"
      And @IgnoreCase Healed should be at least 44% similar to "Heard"
      And @IgnoreCase Healed should not be less than 44% similar to "heard"
      And @IgnoreCase Healed should not be less than 44% similar to "Heard"
      And @IgnoreCase Healed should not be at most 44% similar to "heard"
      And @IgnoreCase Healed should not be at most 44% similar to "Heard"
      And @IgnoreCase Healed should not be more than 45% similar to "heard"
      And @IgnoreCase Healed should not be more than 45% similar to "Heard"
      And @IgnoreCase Healed should not be at least 45% similar to "heard"
      And @IgnoreCase Healed should not be at least 45% similar to "Heard"
      And @IgnoreCase Healed should not be 44% similar to "heard"
      And @IgnoreCase Healed should not be 44% similar to "Heard"
      And @IgnoreCase Healed should be 40% similar to "herded"
      And @IgnoreCase Healed should be 40% similar to "Herded"
      And @IgnoreCase Healed should be 25% similar to "help"
      And @IgnoreCase Healed should be 25% similar to "Help"
      And @IgnoreCase Healed should be 0% similar to "sold"
      And @IgnoreCase Healed should be 0% similar to "Sold"
