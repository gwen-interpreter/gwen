    ...
    Given name is "gwen"
      ...
      And capitalise is defined by js
          ...
          (name) => { 
              ...
              var tail = name.slice(1).toLowerCase()
              return head + tail
          }
          """
      ...
      And fancy full name is
          ...
          ${ 
              (name, surname) => {
                var properName = name.charAt(0).toUpperCase() + name.slice(1).toLowerCase()
                var uppercaseSurname = surname.toUpperCase()
     ...
     Then full name should be "gwen stacey"
      ...
      And fancy full name should be "STACEY, Gwen"
  ...
  Scenario: Invoke the multi argument functions
    Given text1 is "Gwen"
     ...
     Then Multi argument functions should work
      ...
      And text1 should not be "${gwen.scenario.eval.duration}"
      And text2 should not be "${gwen.scenario.eval.duration.msecs}"
      And text2 should not be "${gwen.scenario.eval.duration.secs}"
