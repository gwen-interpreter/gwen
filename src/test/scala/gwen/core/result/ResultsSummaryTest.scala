...
class ResultsSummaryTest extends BaseTest with Matchers with TestModel {
  ...
  "Accumulated feature results in summary" should "sum correctly" in {
    ...
    val metaResult = new SpecResult(meta1, None, Nil, Nil, new Date(), new Date(), 0)
    var featureResult = new SpecResult(feature1, None, Nil, List(metaResult), new Date(), new Date(), 1)
    ...
    featureResult = new SpecResult(feature2, None, Nil, Nil, new Date(), new Date(), 2)
    summary = summary + featureResult
    ...
    featureResult = new SpecResult(feature3, None, Nil, Nil, new Date(), new Date(), 3)
    summary = summary + featureResult
    EvalStatus(summary.results.map(_.spec.evalStatus)).keyword should be (StatusKeyword.Failed)
    ...
    featureResult = new SpecResult(feature4, None, Nil, Nil, new Date(), new Date(), 4)
    summary = summary + featureResult
    EvalStatus(summary.results.map(_.spec.evalStatus)).keyword should be (StatusKeyword.Failed)
    ...
    featureResult = new SpecResult(feature5, None, Nil, Nil, new Date(), new Date(), 5)
    summary = summary + featureResult
    EvalStatus(summary.results.map(_.spec.evalStatus)).keyword should be (StatusKeyword.Failed)
    ...
    featureResult = new SpecResult(feature6, None, Nil, Nil, new Date(), new Date(), 6)
    summary = summary + featureResult
    EvalStatus(summary.results.map(_.spec.evalStatus)).keyword should be (StatusKeyword.Failed)
