...
class NodeChainTest extends FlatSpec with Matchers with MockitoSugar with SpecNormaliser with GherkinParser with TestModel {
  ...
  "Node paths" should "be generared for all nodes in evaluated feature with until loop" in {
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(0).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(0).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]/counter is defined by javascript "0 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(0).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]/counter > 3 is defined by javascript "1 > 3"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(1).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(1).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]/counter is defined by javascript "1 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(1).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]/counter > 3 is defined by javascript "2 > 3"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(2).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(2).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]/counter is defined by javascript "2 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(2).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]/counter > 3 is defined by javascript "3 > 3"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(3).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(3).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]/counter is defined by javascript "3 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]""")
    chain.push(scenario1.steps(1).stepDef.get.steps(3).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]/counter > 3 is defined by javascript "4 > 3"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(0).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][1]/I increment counter[1]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(1).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][2]/I increment counter[1]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(2).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][3]/I increment counter[1]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(3).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/until.feature/Repeat until example[1]/Increment counter with if condition[1]/I increment counter until counter > 3 using no delay if condition[1]/condition[1]/I increment counter until counter > 3 using no delay[1]/counter > 3[1]/I increment counter[1][4]/I increment counter[1]""")
  ...
  "Node paths" should "be generared for all nodes in evaluated feature with while loop" in {
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(0).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(0).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]/I increment counter1[1]/counter1 is defined by javascript "0 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(0).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]/I increment counter1[1]/counter1 < 4 is defined by javascript "1 < 4"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]/I increment counter1[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][1]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(1).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(1).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]/I increment counter1[1]/counter1 is defined by javascript "1 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(1).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]/I increment counter1[1]/counter1 < 4 is defined by javascript "2 < 4"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]/I increment counter1[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][2]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(2).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(2).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]/I increment counter1[1]/counter1 is defined by javascript "2 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(2).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]/I increment counter1[1]/counter1 < 4 is defined by javascript "3 < 4"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]/I increment counter1[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][3]""")
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(3).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(3).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]/I increment counter1[1]/counter1 is defined by javascript "3 + 1"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]/I increment counter1[1]""")
    chain.push(scenario1.steps(2).stepDef.get.steps(3).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]/I increment counter1[1]/counter1 < 4 is defined by javascript "4 < 4"[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]/I increment counter1[1]""")
    chain.pop()
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter1[1]/I increment counter1 while counter1 < 4 using no delay[1]/counter1 < 4[1]/I increment counter1[1][4]""")
    ...
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(0))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(0).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][1]/I increment counter2[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(0).stepDef.get.steps(0))
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(1))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][2]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(1).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][2]/I increment counter2[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(1).stepDef.get.steps(0))
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(2))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][3]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(2).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][3]/I increment counter2[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(2).stepDef.get.steps(0))
    ...
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(3))
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][4]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(3).stepDef.get)
    chain.nodePath should be ("""/target/NodeChainTest/while.feature/Repeat while example[1]/Increment counter2 with if condition[1]/I increment counter2 while counter2 < 4 using no delay if condition[1]/condition[1]/I increment counter2 while counter2 < 4 using no delay[1]/counter2 < 4[1]/I increment counter2[1][4]/I increment counter2[1]""")
    chain.push(scenario2.steps(3).stepDef.get.steps(0).stepDef.get.steps(3).stepDef.get.steps(0))
