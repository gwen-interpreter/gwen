...
class SpecNormaliserTest extends BaseTest with Matchers with SpecNormaliser with GherkinParser with TestModel {
  ...
  "Data driven feature with csv file and no background" should "normalise without error" in {
    val feature = Spec(
    Feature(None, "About me", Nil), None, None, List(
      Scenario(List[Tag](), "What am I?", Nil, None, List(
        Step(StepKeyword.Given.toString, "I am ${my age} year(s) old"),
        Step(StepKeyword.When.toString, "I am a ${my gender}"),
        Step(StepKeyword.Then.toString, "I am a ${my age} year old ${my title}"))
    ...
    result.feature.displayName should be ("About me [1 of 1]")
    result.scenarios.length should be (1)
    result.scenarios(0).background.get.name should be ("Input data record")
    result.scenarios(0).background.get.displayName should be ("Input data record [1 of 1]")
  ...
  "Valid scenario outline" should "normalise" in {
    ...
    scenario1.background.get.steps(1).sourceRef should be (None)
    scenario1.background.get.steps(1).keyword should be(StepKeyword.And.toString)
    scenario1.background.get.steps(1).name should be("""string 2 is "ball"""")
    scenario1.background.get.steps(2).sourceRef should be (None)
    scenario1.background.get.steps(2).keyword should be(StepKeyword.And.toString)
    scenario1.background.get.steps(2).name should be("""result is "basketball"""")
    scenario1.background.get.steps(3).sourceRef.get.line should be (5)
    scenario1.background.get.steps(3).sourceRef.get.toString should be("target/SpecNormaliserTest/outline.feature:5")
    scenario1.background.get.steps(3).keyword should be(StepKeyword.And.toString)
    scenario1.background.get.steps(3).name should be("background step 1")
    ...
    scenario2.background.get.steps(1).sourceRef should be (None)
    scenario2.background.get.steps(1).keyword should be(StepKeyword.And.toString)
    scenario2.background.get.steps(1).name should be("""string 2 is "thing"""")
    scenario2.background.get.steps(2).sourceRef should be (None)
    scenario2.background.get.steps(2).keyword should be(StepKeyword.And.toString)
    scenario2.background.get.steps(2).name should be("""result is "anything"""")
    scenario2.background.get.steps(3).sourceRef.get.line should be (5)
    scenario2.background.get.steps(3).sourceRef.get.toString should be("target/SpecNormaliserTest/outline.feature:5")
    scenario2.background.get.steps(3).keyword should be(StepKeyword.And.toString)
    scenario2.background.get.steps(3).name should be("background step 1")
    ...
    scenario3.background.get.steps(1).sourceRef should be (None)
    scenario3.background.get.steps(1).keyword should be(StepKeyword.And.toString)
    scenario3.background.get.steps(1).name should be("""string 2 is "doo"""")
    scenario3.background.get.steps(2).sourceRef should be (None)
    scenario3.background.get.steps(2).keyword should be(StepKeyword.And.toString)
    scenario3.background.get.steps(2).name should be("""result is "howdydoo"""")
    scenario3.background.get.steps(3).sourceRef.get.line should be (5)
    scenario3.background.get.steps(3).sourceRef.get.toString should be("target/SpecNormaliserTest/outline.feature:5")
    scenario3.background.get.steps(3).keyword should be(StepKeyword.And.toString)
    scenario3.background.get.steps(3).name should be("background step 1")
    ...
    scenario4.background.get.steps(1).sourceRef should be (None)
    scenario4.background.get.steps(1).keyword should be(StepKeyword.And.toString)
    scenario4.background.get.steps(1).name should be("""string 2 is "ok"""")
    scenario4.background.get.steps(2).sourceRef should be (None)
    scenario4.background.get.steps(2).keyword should be(StepKeyword.And.toString)
    scenario4.background.get.steps(2).name should be("""result is "yepok"""")
    scenario4.background.get.steps(3).sourceRef.get.line should be (5)
    scenario4.background.get.steps(3).sourceRef.get.toString should be("target/SpecNormaliserTest/outline.feature:5")
    scenario4.background.get.steps(3).keyword should be(StepKeyword.And.toString)
    scenario4.background.get.steps(3).name should be("background step 1")
    ...
    scenario5.background.get.steps(1).sourceRef should be (None)
    scenario5.background.get.steps(1).keyword should be(StepKeyword.And.toString)
    scenario5.background.get.steps(1).name should be("""string 2 is "dong"""")
    scenario5.background.get.steps(2).sourceRef should be (None)
    scenario5.background.get.steps(2).keyword should be(StepKeyword.And.toString)
    scenario5.background.get.steps(2).name should be("""result is "dingdong"""")
    scenario5.background.get.steps(3).sourceRef.get.line should be (5)
    scenario5.background.get.steps(3).sourceRef.get.toString should be("target/SpecNormaliserTest/outline.feature:5")
    scenario5.background.get.steps(3).keyword should be(StepKeyword.And.toString)
    scenario5.background.get.steps(3).name should be("background step 1")
