...
class SpecNormaliserTest extends BaseTest with Matchers with SpecNormaliser with GherkinParser with TestModel {
  ...
  "Data driven feature with csv file and background" should "normalise without error" in {
    ...
    result.scenarios(0).background.get.description should be (List("Initialise", "Input data file: AboutMe.csv", "Input data record: 1"))
  ...
  "Data driven feature with csv file and no background" should "normalise without error" in {
    ...
    result.feature.name should be ("About me [1]")
    result.scenarios.length should be (1)
    result.scenarios(0).background.get.name should be ("Input data record 1")
  ...
  "Valid scenario outline" should "normalise" in {
    ...
    // scenario1.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]""")
    ...
    // scenario1.background.get.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/background[1]""")
    ...
    // scenario1.background.get.steps(0).sourceRef.get.nodePath.get should be("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/background[1]/background step 1[1]""")
    ...
    // scenario1.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/string 1 is "basket"[1]""")
    ...
    // scenario1.steps(1).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/string 2 is "ball"[1]""")
    ...
    // scenario1.steps(2).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/I join the two strings[1]""")
    ...
    // scenario1.steps(3).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining basket and ball should yield basketball -- Example 1.1 Compound words[1]/the result should be "basketball"[1]""")
    ...
    // scenario2.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]""")
    ...
    // scenario2.background.get.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/background[1]""")
    ...
    // scenario2.background.get.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/background[1]/background step 1[1]""")
    ...
    // scenario2.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/string 1 is "any"[1]""")
    ...
    // scenario2.steps(1).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/string 2 is "thing"[1]""")
    ...
    // scenario2.steps(2).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/I join the two strings[1]""")
    ...
    // scenario2.steps(3).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Compound words[1]/Joining any and thing should yield anything -- Example 1.2 Compound words[1]/the result should be "anything"[1]""")
    ...
    // scenario3.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]""")
    ...
    // scenario3.background.get.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/background[1]""")
    ...
    // scenario3.background.get.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/background[1]/background step 1[1]""")
    ...
    // scenario3.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/string 1 is "howdy"[1]""")
    ...
    // scenario3.steps(1).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/string 2 is "doo"[1]""")
    ...
    // scenario3.steps(2).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/I join the two strings[1]""")
    ...
    // scenario3.steps(3).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining howdy and doo should yield howdydoo -- Example 2.1 Nonsensical compound words[1]/the result should be "howdydoo"[1]""")
    ...
    // scenario4.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]""")
    ...
    // scenario4.background.get.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]/background[1]""")
    ...
    // scenario4.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]/string 1 is "yep"[1]""")
    ...
    // scenario4.steps(1).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]/string 2 is "ok"[1]""")
    ...
    // scenario4.steps(2).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]/I join the two strings[1]""")
    ...
    // scenario4.steps(3).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]/Nonsensical compound words[1]/Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words[1]/the result should be "yepok"[1]""")
    ...
    // scenario5.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]""")
    ...
    // scenario5.background.get.sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/background[1]""")
    ...
    // scenario5.background.get.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/background[1]/background step 1[1]""")
    ...
    // scenario5.steps(0).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/string 1 is "ding"[1]""")
    ...
    // scenario5.steps(1).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/string 2 is "dong"[1]""")
    ...
    // scenario5.steps(2).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/I join the two strings[1]""")
    ...
    // scenario5.steps(3).sourceRef.get.nodePath.get should be ("""/target/SpecNormaliserTest/outline.feature/Outline[1]/Joining <string 1> and <string 2> should yield <result>[1]//Joining ding and dong should yield dingdong -- Example 3.1[1]/the result should be "dingdong"[1]""")
