...
class FeatureSetTest extends BaseTest with Matchers with GherkinParser with SpecNormaliser {
  ...
  private def verify3(dataFilePath: String): Unit = {
    ...
    feature1.scenarios(0).background.get.name should be ("Input data record 1 of 3")
    ...
    feature2.scenarios(0).background.get.name should be ("Input data record 2 of 3")
    ...
    feature3.scenarios(0).background.get.name should be ("Input data record 3 of 3")
