...
class SpecNormaliserTest extends FlatSpec with Matchers with SpecNormaliser with GherkinParser with TestModel {
  ...
  "Valid scenario outline" should "normalise" in {
    ...
    outline.sourceRef.get.pos should be (Position(8, 5, 0))
    outline.tags.map(_.name) should be(List("UnitTest"))
    outline.tags(0).sourceRef.get.pos should be (Position(7, 5, 0))
    ...
    outline.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "<string 1>""""))
    outline.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "<string 2>""""))
    outline.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    outline.steps(3) should be(Step(Position(18, 6, 3), StepKeyword.Then.toString, """the result should be "<result>""""))

    val examples = outline.examples
    examples.size should be(3)

    val example1 = examples(0)
    example1.sourceRef.get.pos should be (Position(20, 5, 0))
    ...
    scenario1.sourceRef.get.pos should be (Position(8, 5, 0))
    scenario1.tags.map(_.name) should be (List("UnitTest"))
    scenario1.tags(0).sourceRef.get.pos should be (Position(7, 5, 0))
    scenario1.name should be("Joining basket and ball should yield basketball -- Example 1.1 Compound words")
    scenario1.background.get.sourceRef.get.pos should be (Position(4, 5, 0))
    scenario1.background.get.name should be ("background")
    scenario1.background.get.steps(0) should be(Step(Position(5, 8, 0), StepKeyword.Given.toString, "background step 1"))
    scenario1.description should be(List("Substituting..", "string 1 = basket", "string 2 = ball", "result = basketball"))
    scenario1.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "basket""""))
    scenario1.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "ball""""))
    scenario1.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    ...
    scenario2.sourceRef.get.pos should be (Position(8, 5, 1))
    ...
    scenario2.background.get.sourceRef.get.pos should be (Position(4, 5, 0))
    scenario2.background.get.name should be ("background")
    scenario2.background.get.steps(0) should be(Step(Position(5, 8, 0), StepKeyword.Given.toString, "background step 1"))
    scenario2.description should be(List("Substituting..", "string 1 = any", "string 2 = thing", "result = anything"))
    scenario2.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "any""""))
    scenario2.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "thing""""))
    scenario2.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    scenario2.steps(3) should be(Step(Position(18, 6, 3), StepKeyword.Then.toString, """the result should be "anything""""))

    val example2 = examples(1)
    example2.sourceRef.get.pos should be (Position(26, 5, 1))
    ...
    scenario3.sourceRef.get.pos should be (Position(8, 5, 0))
    ...
    scenario3.background.get.sourceRef.get.pos should be (Position(4, 5, 0))
    scenario3.background.get.name should be ("background")
    scenario3.background.get.steps(0) should be(Step(Position(5, 8, 0), StepKeyword.Given.toString, "background step 1"))
    scenario3.description should be(List("Substituting..", "string 1 = howdy", "string 2 = doo", "result = howdydoo"))
    scenario3.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "howdy""""))
    scenario3.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "doo""""))
    scenario3.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    scenario3.steps(3) should be(Step(Position(18, 6, 3), StepKeyword.Then.toString, """the result should be "howdydoo""""))

    val scenario4 = example2.scenarios(1)
    scenario4.sourceRef.get.pos should be (Position(8, 5, 1))
    scenario4.tags.map(_.name) should be (List("UnitTest"))
    scenario4.tags(0).sourceRef.get.pos should be (Position(7, 5, 0))
    scenario4.name should be("Joining yep and ok should yield yepok -- Example 2.2 Nonsensical compound words")
    scenario4.background.get.sourceRef.get.pos should be (Position(4, 5, 0))
    scenario4.background.get.name should be ("background")
    scenario4.background.get.steps(0) should be(Step(Position(5, 8, 0), StepKeyword.Given.toString, "background step 1"))
    scenario4.description should be(List("Substituting..", "string 1 = yep", "string 2 = ok", "result = yepok"))
    scenario4.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "yep""""))
    scenario4.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "ok""""))
    scenario4.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    scenario4.steps(3) should be(Step(Position(18, 6, 3), StepKeyword.Then.toString, """the result should be "yepok""""))

    val example3 = examples(2)
    example3.sourceRef.get.pos should be (Position(35, 5, 2))
    ...
    scenario5.sourceRef.get.pos should be (Position(8, 5, 0))
    ...
    scenario5.background.get.sourceRef.get.pos should be (Position(4, 5, 0))
    scenario5.background.get.name should be ("background")
    scenario5.background.get.steps(0) should be(Step(Position(5, 8, 0), StepKeyword.Given.toString, "background step 1"))
    scenario5.description should be(List("Substituting..", "string 1 = ding", "string 2 = dong", "result = dingdong"))
    scenario5.steps(0) should be(Step(Position(15, 5, 0), StepKeyword.Given.toString, """string 1 is "ding""""))
    scenario5.steps(1) should be(Step(Position(16, 7, 1), StepKeyword.And.toString, """string 2 is "dong""""))
    scenario5.steps(2) should be(Step(Position(17, 6, 2), StepKeyword.When.toString, "I join the two strings"))
    scenario5.steps(3) should be(Step(Position(18, 6, 3), StepKeyword.Then.toString, """the result should be "dingdong""""))
