...
class GwenTest extends FlatSpec with Matchers with MockitoSugar {

  private def createApp(options: GwenOptions, interpreter: GwenInterpreter[EvalContext], repl: GwenREPL[EvalContext]) = {
