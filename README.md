...
application testing or online robotic processing.
[Meta specifications](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features) (also expressed in Gherkin) can be
used to define automation bindings and compose [step definitions](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features#composable-step-definitions) to map 'declarative' feature steps to 'imperative' engine steps that perform operations without you needing to develop that code.
