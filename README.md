...
used to define automation bindings and compose [step definitions](https://github.com/gwen-interpreter/gwen/wiki/Meta-Features#composable-step-definitions) that map 'declarative' feature steps to 'imperative' engine steps that perform operations so you don't have to develop code.
